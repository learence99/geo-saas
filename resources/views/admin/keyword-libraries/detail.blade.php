        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                ...
                <div class="flex space-x-2">
                    ...
                    {{-- GEO SaaS：AI 扩词（行业包驱动，写入本库） --}}
                    <a href="{{ route('admin.keyword-libraries.ai-expand', ['libraryId' => (int) $library->id]) }}" class="inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700">
                        <i data-lucide="sparkles" class="w-4 h-4 mr-1"></i>
                        {{ app()->getLocale() === 'en' ? 'AI Expand' : 'AI 扩词' }}
                    </a>
