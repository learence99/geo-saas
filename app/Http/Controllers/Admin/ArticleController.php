    ...
    public function edit(int $articleId): View|RedirectResponse
    {
        ...
        return view('admin.articles.form', [
            ...
            'articleForm' => [
                ...
                'cover_image_source' => (string) ($article->cover_image_source ?? ''),
                'cover_image_credit_name' => (string) ($article->cover_image_credit_name ?? ''),
                'cover_image_credit_url' => (string) ($article->cover_image_credit_url ?? ''),
            ],
